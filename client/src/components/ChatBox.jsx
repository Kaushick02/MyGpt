...
const Chatbox = () => {
  ...
  return (
    ...
    max-md:mt-14 2xl:pr-40'>
      ...
      <div ref={containerRef} className='flex-1 mb-5 overflow-y-scroll'>
        {messages.length === 0 && (
          ...
          text-primary'>
            ...
            <p className='mt-5 text-4xl sm:text-6xl text-gray-400
        ...
        {/* Three Dots Loading */}
        {
          loading && <div className='loading flex items-center gap-1.5'>
      ...
      {/* Prompt Input Box */}
      <form onSubmit={onSubmit} className='bg-primary/20 dark:bg-[#583C79]/30 border 
